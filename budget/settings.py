...
SECRET_KEY = 'django-insecure-d*!95s=nero3@n=1d)3@+qhka2l36qdmx_pg&$dn1q&bq91@e6'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['budget-app-mdt.herokuapp.com']
...
## Need to change database to Heroku credentials
DATABASES = {
    'default': {
